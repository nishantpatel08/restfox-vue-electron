...
export default {
    LOCAL_STORAGE_KEY: {
        ACTIVE_WORKSPACE_ID: 'RestSpark-ActiveWorkspaceId',
        SIDEBAR_WIDTH: 'RestSpark-SidebarWidth',
        REQUEST_PANEL_RATIO: 'RestSpark-RequestPanelRatio',
        RESPONSE_PANEL_RATIO: 'RestSpark-ResponsePanelRatio',
        REQUEST_RESPONSE_LAYOUT: 'RestSpark-RequestResponseLayout',
        THEME: 'RestSpark-Theme',
        GITHUB_STAR_COUNT: 'RestSpark-GithubStarCount',
        DISABLE_PAGE_VIEW_ANALYTICS_TRACKING: 'RestSpark-DisablePageViewAnalyticsTracking',
        DISABLE_SSL_VERIFICATION: 'RestSpark-DisableSSLVerification',
        DISABLE_IFRAME_SANDBOX: 'RestSpark-DisableIframeSandbox',
        DISABLE_AUTO_UPDATE: 'RestSpark-DisableAutoUpdate',
        ELECTRON_SWITCH_TO_CHROMIUM_FETCH: 'RestSpark-ElectronSwitchToChromiumFetch',
        GENERATE_CODE_LANGUAGE: 'RestSpark-GenerateCodeLanguage',
        GENERATE_CODE_CLIENT: 'RestSpark-GenerateCodeClient',
        GLOBAL_USER_AGENT: 'RestSpark-GlobalUserAgent',
